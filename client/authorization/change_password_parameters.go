...
// WithNonce adds the nonce to the change password params
func (o *ChangePasswordParams) WithNonce(nonce string) *ChangePasswordParams {
	o.SetNonce(nonce)
	return o
}

// SetNonce adds the nonce to the change password params
func (o *ChangePasswordParams) SetNonce(nonce string) {
	o.Nonce = nonce
}
...
func (o *ChangePasswordParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param nonce
	if err := r.SetPathParam("nonce", o.Nonce); err != nil {
		return err
	}
