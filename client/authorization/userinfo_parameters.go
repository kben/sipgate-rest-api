...
// WithAuthorization adds the authorization to the userinfo params
func (o *UserinfoParams) WithAuthorization(authorization *string) *UserinfoParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the userinfo params
func (o *UserinfoParams) SetAuthorization(authorization *string) {
