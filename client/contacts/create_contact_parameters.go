...
// WithBody adds the body to the create contact params
func (o *CreateContactParams) WithBody(body *models.CreateContactRequest) *CreateContactParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create contact params
func (o *CreateContactParams) SetBody(body *models.CreateContactRequest) {
	o.Body = body
}
