...
type ClientService interface {
	...
	GetBalance(params *GetBalanceParams, authInfo runtime.ClientAuthInfoWriter) (*GetBalanceOK, error)

	Verify(params *VerifyParams, authInfo runtime.ClientAuthInfoWriter) error

	SetTransport(transport runtime.ClientTransport)
}

/*
  GetAccount gets account data
*/
...
*/
func (a *Client) GetBalance(params *GetBalanceParams, authInfo runtime.ClientAuthInfoWriter) (*GetBalanceOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) Verify(params *VerifyParams, authInfo runtime.ClientAuthInfoWriter) error {
	// TODO: Validate the params before sending
	if params == nil {
