...
// WithGroupID adds the groupID to the get group users params
func (o *GetGroupUsersParams) WithGroupID(groupID string) *GetGroupUsersParams {
	o.SetGroupID(groupID)
	return o
}

// SetGroupID adds the groupId to the get group users params
func (o *GetGroupUsersParams) SetGroupID(groupID string) {
	o.GroupID = groupID
}
